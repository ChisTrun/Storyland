...
namespace backend.Controllers
{
    ...
    public class Searching : Controller
    {
        ...
        {
            return Ok(StorySourceScanner.Instance.Commands[1].GetStoriesOfAuthor(authorId));
        }
        ...
        {
            return Ok(StorySourceScanner.Instance.Commands[1].GetStoriesOfAuthor(authorId, page, limit));
        }
        ...
        {
            return Ok(StorySourceScanner.Instance.Commands[1].GetStoriesBySearchName(storyName));
        }
        ...
        {
            return Ok(StorySourceScanner.Instance.Commands[1].GetStoriesBySearchName(storyName, page, limit));
        }
    }
}
